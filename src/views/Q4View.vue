<template>
    <div class="Q4">
      ...
      <button type="button" style="width:350px; height:350px; font-size:30px; position: fixed; bottom: 13cm; right: 16cm;" @click="correct()"> B
        <img v-bind:src="picture" width="300" height="300">
        <p style="font-size:25px;">ans</p>
      </button>
  ...
  export default {
    ...
    methods:{
      ...
      this.$router.push({name:'corr4'});
      },
      wrong(){
      localStorage.setItem("auth",false);
      this.$router.push({name:'wrong4'});
      },
    }
    }
  </script>
